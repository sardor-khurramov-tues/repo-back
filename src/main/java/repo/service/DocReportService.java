...
public class DocReportService {
    ...
    @Transactional
    public ResponseEntity<ResponseDto<Long>> create(DocReportSubmitDto dto) {
        ...
        document.setDocType(DocType.REPORT);
    ...
    @Transactional
    public ResponseEntity<ResponseDto<DocumentDto>> update(Long id, DocReportUpdateDto dto) {
